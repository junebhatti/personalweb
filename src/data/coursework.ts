...
export const courses: Course[] = [
  ...
  },
  {
    ...
    scores: {
      ...
      enjoyment: 0.4,
      applicability: 0.6,
      // TODO: still the old value — the new one was cut off mid-sentence.
      surprise: 0.2,
    },
  },
  {
  ...
  },
  {
    ...
    comment: 'law school styled seminar not for me, some cool readings though',
    important: false,
    loved: false,
    scores: {
      interesting: 0.7,
  ...
  },
  {
    ...
    comment:
      "Some super interesting short stories, but wasn't a fan of the novels we read",
    important: false,
    loved: false,
    scores: {
      interesting: 0.7,
